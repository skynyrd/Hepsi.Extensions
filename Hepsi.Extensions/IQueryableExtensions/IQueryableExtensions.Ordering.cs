...
namespace Hepsi.Extensions.IQueryableExtensions
{
    public static partial class IQueryableExtensions
    {
        ...
        public static IQueryable<T> DynamicOrderBy<T>(this IQueryable<T> source, OrderByRequest orderByRequest)
        {
            ...
            string methodName = RetrieveOrderByMethodName(orderByRequest.Direction);
            ...
            {
                var thenByExpression = GetMemberAccessExpressionAndSubPropertyType<T>(
                    propertyName: thenByRequest.Key).Item2;
            ...
            string propertyName)
        {
            ...
            ParameterExpression parameterExpression = Expression.Parameter(type, "doc");
